...
from send_email import send_linkedin_post_email
...
def search_tech_news(state: GraphState) -> GraphState:
    results = tavily.search(
        topic="finance",
        query="Top stock market news today for india",
...
From the following finanice and stock news articles related to India, choose the most interesting and trending one.

Summarize it in 8-10 sentences for a professional audience:
...
- It should be relevant to the Indian stock market and finance industry.
-Humanize the post to make it more relatable.
...
if __name__ == "__main__":
    ...
    # 🔔 Send it to email
    send_linkedin_post_email(final_post)